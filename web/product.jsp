<%-- 
    Document   : product
    Created on : Mar 8, 2025, 11:52:01 PM
            ...
            <div class="table-wrapper">               
                <div class="table-title">                    
                    <div class="row">                       
                        ...
                        <div class="col-sm-6">
                            <a href="#addProductModel"  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>
                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>${o.price} $</td>
                                <td>
                                    <a href="loadprd?pid=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
