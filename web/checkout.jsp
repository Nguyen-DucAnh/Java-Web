<%-- 
    Document   : checkout
    Created on : Mar 6, 2025, 1:10:13 PM
                    ...
                    <div class="card border-secondary mb-5">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3 pt-1">
                                ...
                                <h6 class="font-weight-medium">${subtotal} VNĐ<fmt:formatNumber value="${subtotal}" type="number" pattern="#,##0.00" /></h6>
                            </div>
                            <div class="d-flex justify-content-between">
                                <h6 class="font-weight-medium">Shipping</h6>
                                <h6 class="font-weight-medium">10 VNĐ</h6>
                            </div>
                        </div>
                        <div class="card-footer border-secondary bg-transparent">
                            <div class="d-flex justify-content-between mt-2">
                                <h5 class="font-weight-bold">Total</h5>
                                <h5 class="font-weight-bold">${subtotal + 10} VNĐ<fmt:formatNumber value="${subtotal + 10}" type="number" pattern="#,##0.00" /></h5>
                            </div>
                        </div>
                    </div>
                    <div class="card border-secondary mb-5">
                        ...
                        <div class="card-footer border-secondary bg-transparent">
                            <form action="VNpay" method="GET">
                                <input type="hidden" name="amount" value="${subtotal + 10}">
                                <input type="hidden" name="orderInfo" value="Payment for Order">
